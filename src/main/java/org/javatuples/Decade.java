...
public final class Decade<A,B,C,D,E,F,G,H,I,J> extends Tuple {
    ...
    public <X> Decade<X,B,C,D,E,F,G,H,I,J> setAtPos0(final X value) {
    ...
    public <X> Decade<A,X,C,D,E,F,G,H,I,J> setAtPos1(final X value) {
    ...
    public <X> Decade<A,B,X,D,E,F,G,H,I,J> setAtPos2(final X value) {
    ...
    public <X> Decade<A,B,C,X,E,F,G,H,I,J> setAtPos3(final X value) {
    ...
    public <X> Decade<A,B,C,D,X,F,G,H,I,J> setAtPos4(final X value) {
    ...
    public <X> Decade<A,B,C,D,E,X,G,H,I,J> setAtPos5(final X value) {
    ...
    public <X> Decade<A,B,C,D,E,F,X,H,I,J> setAtPos6(final X value) {
    ...
    public <X> Decade<A,B,C,D,E,F,G,X,I,J> setAtPos7(final X value) {
    ...
    public <X> Decade<A,B,C,D,E,F,G,H,X,J> setAtPos8(final X value) {
    ...
    public <X> Decade<A,B,C,D,E,F,G,H,I,X> setAtPos9(final X value) {
